...
namespace ICD.Profound.ConnectPRO.Themes.TouchDisplayInterface.Presenters.Conference.Contacts
{
	...
	public sealed class ReferencedSelectedContactPresenter : AbstractTouchDisplayComponentPresenter<IReferencedSelectedContactView>, IReferencedSelectedContactPresenter
	{
		...
		public ReferencedSelectedContactPresenter(ITouchDisplayNavigationController nav, ITouchDisplayViewFactory views, ConnectProTheme theme) : base(nav, views, theme)
		{
