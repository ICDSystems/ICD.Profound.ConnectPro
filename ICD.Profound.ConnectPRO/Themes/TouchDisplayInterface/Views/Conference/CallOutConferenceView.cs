...
{
	[ViewBinding(typeof(ICallOutConferenceView))]
	public sealed partial class CallOutConferenceView : AbstractTouchDisplayView, ICallOutConferenceView
	{
		/// <summary>
		...
		public CallOutConferenceView(ISigInputOutput panel, ConnectProTheme theme)
			: base(panel, theme)
		{
		}
