...
namespace ICD.Profound.ConnectPRO.Themes.TouchDisplayInterface.Views.Settings
{
	public sealed partial class SettingsPasscodeView
	{
		...
		protected override void InstantiateControls(ISigInputOutput panel, IVtProParent parent, ushort index)
		{
			...
			{
				DigitalVisibilityJoin = 1005
			};

			m_PasscodeLabel = new VtProFormattedText(panel, m_Subpage);
			m_PasscodeLabel.SerialLabelJoins.Add(1005);

			m_VersionLabel = new VtProSimpleLabel(panel, m_Subpage)
			{
				IndirectTextJoin = 1006
			};

			m_Keypad = new VtProSimpleKeypad(1005, panel as IPanelDevice, m_Subpage);

			m_CancelButton = new VtProButton(panel, m_Subpage)
			{
				DigitalPressJoin = 1006
			};
		}
