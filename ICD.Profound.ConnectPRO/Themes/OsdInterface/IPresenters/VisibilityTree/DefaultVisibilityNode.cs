...
namespace ICD.Profound.ConnectPRO.Themes.OsdInterface.IPresenters.VisibilityTree
{
	...
	{
		private readonly IOsdPresenter m_DefaultPresenter;
		...
		public DefaultVisibilityNode(IOsdPresenter defaultPresenter)
		{
		...
		private void DefaultPresenterOnVisibilityChanged(object sender, BoolEventArgs args)
		{
			...
			foreach (IOsdPresenter presenter in GetPresenters().Where(c => c != m_DefaultPresenter))
