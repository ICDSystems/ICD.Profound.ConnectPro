...
namespace ICD.Profound.ConnectPRO.Themes.OsdInterface.IPresenters.VisibilityTree
{
	...
	public abstract class AbstractVisibilityNode : IVisibilityNode
	{
		...
		private readonly IcdHashSet<IOsdPresenter> m_Presenters;
		...
		protected AbstractVisibilityNode()
		{
			...
			m_Presenters = new IcdHashSet<IOsdPresenter>();
		...
		/// <returns></returns>
		public void AddPresenter(IOsdPresenter presenter)
		{
		...
		/// </summary>
		/// <returns></returns>
		public IEnumerable<IOsdPresenter> GetPresenters()
		{
		...
		/// </summary>
		/// <param name="presenter"></param>
		private void Subscribe(IOsdPresenter presenter)
		{
		...
		protected virtual void NodeOnChildVisibilityChanged(IVisibilityNode parent, IOsdPresenter presenter, bool visibility)
		{
