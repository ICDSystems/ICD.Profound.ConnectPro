...
{
	public sealed partial class OptionMasterMicView : AbstractOptionView, IOptionContactsView
	{
		...
		public OptionMasterMicView(ISigInputOutput panel, ConnectProTheme theme)
			: base(panel, theme)
		{
		}
