...
{
	public sealed partial class SourceSelectSingleView : AbstractSourceSelectView, ISourceSelectSingleView
	{
		...
		public SourceSelectSingleView(ISigInputOutput panel, ConnectProTheme theme)
			: base(panel, theme)
		{
