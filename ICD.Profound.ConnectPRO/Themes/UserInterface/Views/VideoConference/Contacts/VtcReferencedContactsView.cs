...
{
	[ViewBinding(typeof(IVtcReferencedContactsView))]
	public sealed partial class VtcReferencedContactsView : AbstractComponentView, IVtcReferencedContactsView
	{
		...
		public VtcReferencedContactsView(ISigInputOutput panel, IConnectProTheme theme, IVtProParent parent, ushort index)
