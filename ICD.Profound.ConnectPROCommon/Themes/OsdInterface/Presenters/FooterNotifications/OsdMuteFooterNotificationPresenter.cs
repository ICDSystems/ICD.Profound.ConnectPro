...
{
	[PresenterBinding(typeof(IOsdMuteFooterNotificationPresenter))]
	public sealed class OsdMuteFooterNotificationPresenter : AbstractOsdPresenter<IOsdMuteFooterNotificationView>, IOsdMuteFooterNotificationPresenter
	{
		...
		public OsdMuteFooterNotificationPresenter(IOsdNavigationController nav, IOsdViewFactory views, IConnectProTheme theme)
