...
{
	[PresenterBinding(typeof(IOsdTouchFreeHeaderNotificationPresenter))]
	public sealed class OsdTouchFreeHeaderNotificationPresenter : AbstractOsdPresenter<IOsdTouchFreeHeaderNotificationView>, IOsdTouchFreeHeaderNotificationPresenter
	{
		...
		public OsdTouchFreeHeaderNotificationPresenter(IOsdNavigationController nav, IOsdViewFactory views, IConnectProTheme theme) : base(nav, views, theme)
		{
			m_RefreshSection = new SafeCriticalSection();
		}

		protected override void Refresh(IOsdTouchFreeHeaderNotificationView view)
		{
			base.Refresh(view);
