...
namespace ICD.Profound.ConnectPROCommon.Themes.OsdInterface.Views.Conference
{
	[ViewBinding(typeof(IOsdConferenceView))]
	public sealed partial class OsdConferenceView : AbstractOsdView, IOsdConferenceView
	{
		public OsdConferenceView(ISigInputOutput panel, IConnectProTheme theme) : base(panel, theme)
		{
		}
