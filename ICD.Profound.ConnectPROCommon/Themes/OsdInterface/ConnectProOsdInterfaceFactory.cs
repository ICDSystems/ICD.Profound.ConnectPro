...
{
	public sealed class ConnectProOsdInterfaceFactory : AbstractConnectProUserInterfaceFactory<IConnectProTheme, ConnectProOsdInterface>
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="theme"></param>
		public ConnectProOsdInterfaceFactory(IConnectProTheme theme)
			: base(theme)
		{
		}
