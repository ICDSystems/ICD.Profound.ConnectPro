...
namespace ICD.Profound.ConnectPROCommon.Themes.ShureMx396Interface
{
	public sealed class ConnectProShureMx396InterfaceFactory :
		AbstractConnectProUserInterfaceFactory<IConnectProTheme, ConnectProShureMx396Interface>
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="theme"></param>
		public ConnectProShureMx396InterfaceFactory(IConnectProTheme theme)
			: base(theme)
		{
		}
