...
namespace ICD.Profound.ConnectPROCommon.Themes.ShureMicrophoneInterface
{
	public sealed class ConnectProShureMicrophoneInterfaceFactory :
		AbstractConnectProUserInterfaceFactory<IConnectProTheme, ConnectProShureMicrophoneInterface>
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="theme"></param>
		public ConnectProShureMicrophoneInterfaceFactory(IConnectProTheme theme)
			: base(theme)
		{
		}
