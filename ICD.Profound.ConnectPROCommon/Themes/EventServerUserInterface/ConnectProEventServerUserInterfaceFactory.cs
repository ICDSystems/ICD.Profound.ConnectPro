...
namespace ICD.Profound.ConnectPROCommon.Themes.EventServerUserInterface
{
	public sealed class ConnectProEventServerUserInterfaceFactory :
		AbstractConnectProUserInterfaceFactory<IConnectProTheme, ConnectProEventServerUserInterface>
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="theme"></param>
		public ConnectProEventServerUserInterfaceFactory(IConnectProTheme theme)
			: base(theme)
		{
		}
