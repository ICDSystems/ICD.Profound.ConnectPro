...
{
	public abstract class AbstractConnectProThemeSettings : AbstractThemeSettings, IConnectProThemeSettings
	{
		...
		public override void ParseXml(string xml)
		{
			...
			Logo = XmlUtils.TryReadChildElementContentAsString(xml, LOGO_ELEMENT) ?? LOGO_DEFAULT;
