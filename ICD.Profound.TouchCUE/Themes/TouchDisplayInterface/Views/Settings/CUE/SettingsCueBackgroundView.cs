...
namespace ICD.Profound.TouchCUE.Themes.TouchDisplayInterface.Views.Settings.CUE
{
	[ViewBinding(typeof(ISettingsCueBackgroundView))]
	public sealed partial class SettingsCueBackgroundView : AbstractTouchDisplayView, ISettingsCueBackgroundView
	{
		...
		public SettingsCueBackgroundView(ISigInputOutput panel, TouchCueTheme theme)
			: base(panel, theme)
		{
		}
