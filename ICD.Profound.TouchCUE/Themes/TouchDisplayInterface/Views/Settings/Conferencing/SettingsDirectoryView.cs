...
namespace ICD.Profound.TouchCUE.Themes.TouchDisplayInterface.Views.Settings.Conferencing
{
	...
	public sealed partial class SettingsDirectoryView : AbstractTouchDisplayView, ISettingsDirectoryView
	{
		...
		public SettingsDirectoryView(ISigInputOutput panel, TouchCueTheme theme)
			: base(panel, theme)
		{
		}
