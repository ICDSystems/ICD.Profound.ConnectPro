...
namespace ICD.Profound.TouchCUE.Themes.TouchDisplayInterface.Views.Settings
{
	...
	public sealed partial class SettingsPasscodeView : AbstractTouchDisplayView, ISettingsPasscodeView
	{
		/// <summary>
		...
		public SettingsPasscodeView(ISigInputOutput panel, TouchCueTheme theme)
			: base(panel, theme)
		{
		}
