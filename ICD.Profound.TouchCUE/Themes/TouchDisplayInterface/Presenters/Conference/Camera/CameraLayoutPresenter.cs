...
namespace ICD.Profound.TouchCUE.Themes.TouchDisplayInterface.Presenters.Conference.Camera
{
	...
	public sealed class CameraLayoutPresenter : AbstractTouchDisplayPresenter<ICameraLayoutView>, ICameraLayoutPresenter
	{
		...
		public CameraLayoutPresenter(ITouchDisplayNavigationController nav, ITouchDisplayViewFactory views, TouchCueTheme theme) 
		...
		protected override void Refresh(ICameraLayoutView view)
		{
			...
			try
			{
				...
				bool layoutAvailable = m_LayoutComponent != null;
